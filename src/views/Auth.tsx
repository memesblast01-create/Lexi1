                ...
                <div className="space-y-2">
                  ...
                  <div className="relative group">
                    ...
                    <input 
                      ...
                      className="w-full pl-11 pr-11 py-3 bg-white border border-slate-200 rounded-lg outline-none focus:ring-2 focus:ring-blue-500/10 focus:border-brand-secondary transition-all text-sm text-slate-900 placeholder:text-slate-400"
